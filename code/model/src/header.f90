...
!  INTEGER, PARAMETER :: out1d_int=1, out2d_int=2, out3d_int=3
  INTEGER :: out1d_int, out2d_int, out3d_int             !@ out?d_int: frequency of output, in namelist
...
!------------------------------------------------------------------------!
 ...
 !------------------------
  ...
  REAL(kind=rc_kind) ::  time_nondim,time_seconds                    !@ nondimensional time, time in seconds
  ...
  REAL(kind=rc_kind) ::  Kx, Ky                                      !@ variables used in diffusion, in namelist
 ...
 ! netcdf output
  ...
  INTEGER :: save_steps
  INTEGER :: frame_int,ngraph2d,pickup_int
  INTEGER :: pickup_step
